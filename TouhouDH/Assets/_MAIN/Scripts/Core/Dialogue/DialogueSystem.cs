...
namespace DIALOGUE
{
    public class DialogueSystem : MonoBehaviour
    {
        ...
        public void ApplySpeakerDataToDialogueContainer(CharacterConfigData config)
        {
            ...
            dialogueContainer.SetDialogueFontSize(DialogueSystemConfigurationSO.DEFAULT_FONTSIZE_DIALOGUE);

            //Set name details
            dialogueContainer.nameContainer.SetNameColor(config.nameColor);
            dialogueContainer.nameContainer.SetNameFont(config.nameFont);
            fontSize = this.config.defaultNameFontSize * config.nameFontScale;
            dialogueContainer.nameContainer.SetNameFontSize(DialogueSystemConfigurationSO.DEFAULT_FONTSIZE_NAME);
        }
