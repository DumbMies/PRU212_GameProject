...
namespace DIALOGUE
{
    public class DialogueContinuePrompt : MonoBehaviour
    {
        ...
        public void Show()
        {
            ...
            //Vector3 characterTopLeft = finalCharacter.topLeft;
            //Vector3 characterBottomRight = finalCharacter.bottomRight;
            //Vector3 targetPos = (characterTopLeft + characterBottomRight) / 2;
            Vector3 targetPos = finalCharacter.bottomRight;
            float characterWidth = finalCharacter.pointSize * 1f;
            targetPos = new Vector3(targetPos.x + characterWidth, targetPos.y + 9, 0);
