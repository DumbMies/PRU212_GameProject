...
public class FilePaths
{
    ...
    public static readonly string resources_UI = $"{resources_graphics}UI/";
    ...
    ///<summary>
    ///Returns the path to the resource using the default path or the root of the resources folder
    ///</summary>
