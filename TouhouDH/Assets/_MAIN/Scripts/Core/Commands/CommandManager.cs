...
namespace COMMANDS
{
    public class CommandManager : MonoBehaviour
    {
        ...
        public const string DATABASE_CHARACTER_SPRITE = "characters-sprite";
        ...
        private void Awake()
        {
            if (instance == null)
            {
                ...
                foreach (Type extension in extentionTypes)
                {
        ...
        private CoroutineWrapper ExecuteCharacterCommand(string commandName, params string[] args)
        {
            ...
            Debug.LogError($"Command Manager was unable to execute command '{commandName}' on character '{args[0]}'. The character name or command maybe invalid.");
            return null;
        }
