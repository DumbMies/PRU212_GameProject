...
namespace COMMANDS
{
    public class CMD_DatabaseExtension_GraphicsPanel : CMD_DatabaseExtension
    {
        ...
        {
            //Parameters avaliable to function
            string panelName = "";
            int layer = 0;
            string mediaName = "";
            ...
            GraphicLayer graphicLayer = panel.GetLayer(layer, createIfDoeNotExist: true);
