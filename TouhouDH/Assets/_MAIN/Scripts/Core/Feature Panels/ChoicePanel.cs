...
public class ChoicePanel : MonoBehaviour
{
    ...
    private const float BUTTON_MIN_WIDTH = 700;
    private const float BUTTON_MAX_WIDTH = 1000;
    private const float BUTTON_WIDTH_PADDING = 5;
    ...
    public void SetWaitingOnUserChoice(bool value)
    {
        isWaitingOnUserChoice = value;
    }
