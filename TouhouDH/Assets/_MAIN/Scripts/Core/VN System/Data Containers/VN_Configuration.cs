...
public class VN_Configuration
{
    ...
    public void Load()
    {
        ...
        ConfigMenu.instance.SetContinueSkippingAfterChoice(continueSkippingAfterChoice);

        //Set the value of the architext and auto reader speed
        ui.architectSpeed.value = dialogueTextSpeed;
        ui.autoReaderSpeed.value = dialogueAutoReadSpeed;

        ConfigMenu.instance.SetTextArchitectSpeed();
        ConfigMenu.instance.SetAutoReaderSpeed();
