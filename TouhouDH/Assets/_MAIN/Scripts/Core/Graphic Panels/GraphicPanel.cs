...
public class GraphicPanel 
{
    ...
    public bool isClear => layers == null || layers.Count == 0 || layers.TrueForAll(layer => layer.currentGraphic == null);

    public GraphicLayer GetLayer(int layerDepth, bool createIfDoeNotExist = false)
    {
