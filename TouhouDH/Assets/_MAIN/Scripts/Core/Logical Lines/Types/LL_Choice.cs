...
namespace DIALOGUE.LogicalLines
{
    public class LL_Choice : ILogicalLine
    {
        ...
        public IEnumerator Execute(DIALOGUE_LINE line)
        {
            ...
            EncapsulatedData data = RipEncapsulationData(currentConversation, progress, ripHeaderAndEncapsulation: true, parentStartingIndex: currentConversation.fileStartIndex);
