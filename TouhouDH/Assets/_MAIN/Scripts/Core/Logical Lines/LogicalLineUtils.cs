...
namespace DIALOGUE.LogicalLines
{
    public static class LogicalLineUtils
    {
        public static class Encapsulation
        {
            ...
            public static EncapsulatedData RipEncapsulationData(Conversation conversation, int startingIndex, bool ripHeaderAndEncapsulation = false, int parentStartingIndex = 0)
            {
                ...
                for (int i = startingIndex; i < conversation.Count; i++)
                {
                    ...
                    if (ripHeaderAndEncapsulation || (encapsulationDepth > 0 && !IsEncapsulationEnd(line)))
                    data.lines.Add(line);
        ...
        public static class Expressions
        {
            ...
            private static object ExtractValue(string value)
            {
                ...
                if (value.StartsWith(VariableStore.VARIABLE_ID))
                {
                    ...
                    if (!VariableStore.HashVariable(variableName))
                    {
